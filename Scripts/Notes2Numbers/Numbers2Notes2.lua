...
-- 	 Updated the Default Sounds (Now requires Surge)
...
function Setup_Tracks() -- ERASE OLD TRACK (IF NEEDED) AND SET UP A REPLACEMENT
    ...
    local track_table = {
        ...
        [5] = {"N2N Lead", found_bool_lead1, trackID_lead1, 0,
			{{"HeadStart",true},{"SwingTrackMIDI",true},{"ReaCenterMIDIpitch",false},{"Surge XT",true},{"Calibre",true},{"Isolator",true}, {"Holt",true}}, 
			{3}, 0, {108, 162, 123},0},		
		-- =========================================================================================================================
        ...
        [7] = {"N2N Chord Sustain",found_bool_chord_sus,trackID_chord_sus,0,
			{{"HeadStart",true},{"ThisTriggersThat",false},{"ReaPulsive-8ths",false},{"SwingTrackMIDI",true},{"ReaCenterMIDIpitch",false},{"Surge XT",true},{ "Calibre",true},{ "Isolator",true},{ "Holt",true}},
			{3},0,{134, 172, 181},.1},
        [8] = {"N2N Chord + LibreARP",found_bool_chord_librearp,trackID_chord_librearp,0,
			{{"HeadStart",true},{"LibreARP",true},{ "ReaPulsive-8ths",false},{"SwingTrackMIDI",true},{"ReaCenterMIDIpitch",false},{ "Surge XT",true},{ "Calibre",true},{ "Isolator",true},{ "Holt",true},{ "STFU",false}},
			{3},0,{134, 172, 181},.8},
		[9] = {"N2N Chord + STFU",found_bool_chord_stfu1,trackID_chord_stfu1,0,
			{{"HeadStart",true},{"ReaPulsive-8ths",true},{"SwingTrackMIDI",true},{"ReaCenterMIDIpitch",false},{"Surge XT",true},{"Calibre",true},{"Isolator",true},{"Holt",true},{"STFU",false},{"STFU",false}},
			{3},0,{134, 172, 181},.4},
		-- =========================================================================================================================		
		...
		[13] = {"N2N Bass",found_bool_bass_sus,trackID_bass_sus,0,
			{{"HeadStart",true},{"ReaPulsive-8ths",false},{"SwingTrackMIDI",true},{"ReaCenterMIDIpitch",false},{"Surge XT",true},{ "Calibre",true},{ "Isolator",true},{ "Holt",true},{"STFU",false}},
			{3},0,{134, 153, 181},.1},
		[14] = {"N2N Bass + LibreARP",found_bool_bass_librearp,trackID_bass_librearp,0,
			{{"HeadStart",true},{"LibreARP",true},{"ReaPulsive-16ths",false},{"SwingTrackMIDI",true},{"ReaCenterMIDIpitch",false},{"Surge XT",true},{"Calibre",true},{"Isolator",true},{"Holt",true},{"STFU",false}},
			{3},0,{134, 153, 181},.8},
		[15] = {"N2N Bass + STFU",found_bool_bass_stfu1,trackID_bass_stfu1,0,
			{{"HeadStart",true},{"ReaPulsive-8ths",true},{"SwingTrackMIDI",true},{"ReaCenterMIDIpitch",false},{"Surge XT",true},{"Calibre",true},{"Isolator",true},{"Holt",true},{"STFU",true},{"STFU",false}},
			{3},0,{134, 153, 181},.8},
		-- =========================================================================================================================			
